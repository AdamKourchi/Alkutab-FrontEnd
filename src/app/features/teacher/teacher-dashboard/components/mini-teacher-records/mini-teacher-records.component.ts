...
@Component({
  selector: 'app-mini-teacher-records',
  imports: [    MatCardModule,
    ...
    MatDialogModule,
    ReactiveFormsModule,],
  templateUrl: './mini-teacher-records.component.html',
  styleUrl: './mini-teacher-records.component.css'
})
export class MiniTeacherRecordsComponent {
  ...
  getStudentsWithRecords() {
    console.log('Fetching students for circle ID:', this.circleId);
...
//           mark: null,
//         };
//         const createdNewWajib =  await this.wajibService.createWajib(newWajib, this.selectedStudent);
